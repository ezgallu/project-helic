...
B_eq_p = 0.2;%0.415;  % tuned while running simulation and experiment in parallel
B_eq_y = 0.2;%0.318; % identified as described in manual 
% Mass of the Helicopter (kg)
m_heli = 0.6; %1.3872;
% Mass of the Helicopter with Yoke (kg)
m_heli_case = 0.95; %1.421;
% Distance from Pitch Pivot to Pitch/Front Motor and Yaw/Back Motor(m)
r_p = 0.2;%7.75*0.0254;
r_y = 0.18;%(6+5/8)*0.0254;
...
L_shaft = 0.05; %11 * 0.0254;
% Pitch and Yaw Motor Rotor Moment of Inertia (kg.m^2)
J_m_p = 4.1e-6;% 1.91e-6; %1.7070e-5;
J_m_y = 4.1e-6;%1.374e-4; %1.4471e-5;
