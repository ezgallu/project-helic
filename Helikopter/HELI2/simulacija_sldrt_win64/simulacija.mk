...
MODEL                := simulacija
MODULES              := rtGetInf.c rtGetNaN.c rt_nonfinite.c simulacija_data.c simulacija_tgtconn.c 
MAKEFILE             := simulacija.mk
...
#
MODELLIB                  := simulacijalib_sldrt.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := simulacija_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;D:/Studentski_radovi/Helikopter/HELI2/simulacija_sldrt_win64;D:/Studentski_radovi/Helikopter/HELI2;D:/Studentski_radovi/Leskovic;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
