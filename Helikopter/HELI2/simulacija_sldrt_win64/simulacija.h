...
#ifndef RTW_HEADER_simulacija_h_
#define RTW_HEADER_simulacija_h_
#include <string.h>
#ifndef simulacija_COMMON_INCLUDES_
# define simulacija_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#include "ext_work.h"
#include "sldrtdef.h"
#endif                                 /* simulacija_COMMON_INCLUDES_ */

#include "simulacija_types.h"
...
#define simulacija_rtModel             RT_MODEL_simulacija_T
...
#define rtB                            simulacija_B
#define BlockIO                        B_simulacija_T
#define rtP                            simulacija_P
#define Parameters                     P_simulacija_T
#define rtDWork                        simulacija_DW
#define D_Work                         DW_simulacija_T

/* Parameters (auto storage) */
struct P_simulacija_T_ {
  ...
  real_T Saturation1_LowerSat;         /* Expression: -5
                                        * Referenced by: '<Root>/Saturation1'
                                        */
  real_T Step1_Time;                   /* Expression: 14
...
extern P_simulacija_T simulacija_P;

/* Block signals (auto storage) */
extern B_simulacija_T simulacija_B;

/* Block states (auto storage) */
extern DW_simulacija_T simulacija_DW;

/* Model entry point functions */
extern void simulacija_initialize(void);
extern void simulacija_output(void);
extern void simulacija_update(void);
extern void simulacija_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern simulacija_rtModel *simulacija(void);
...
extern RT_MODEL_simulacija_T *const simulacija_M;
 ...
 * '<S1>'   : 'simulacija/Ramp'
 */
#endif                                 /* RTW_HEADER_simulacija_h_ */
