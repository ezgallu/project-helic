...
MODEL                := ukupni_model
MODULES              := rtGetInf.c rtGetNaN.c rt_nonfinite.c ukupni_model_data.c ukupni_model_tgtconn.c 
MAKEFILE             := ukupni_model.mk
...
#
MODELLIB                  := ukupni_modellib_sldrt.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := ukupni_model_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;D:/Studentski_radovi/Helikopter/HELI2/ukupni_model_sldrt_win64;D:/Studentski_radovi/Helikopter/HELI2;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
