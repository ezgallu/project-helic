...
% Last Modified by GUIDE v2.5 23-May-2017 11:01:02
...
handles.model_name = 'ukupni_model/Referentni kut';
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
pitch = get(handles.pitch_edit,'String');
yaw = get(handles.yaw_edit,'String');
set_param([handles.model_name '/Constant'],'Value',pitch);
set_param([handles.model_name '/Constant: Yaw (deg)'],'Value',yaw);
