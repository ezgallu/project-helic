...
#ifndef RTW_HEADER_PIDbrzina_h_
#define RTW_HEADER_PIDbrzina_h_
#include <math.h>
#include <string.h>
#ifndef PIDbrzina_COMMON_INCLUDES_
# define PIDbrzina_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#include "ext_work.h"
#include "sldrtdef.h"
#endif                                 /* PIDbrzina_COMMON_INCLUDES_ */

#include "PIDbrzina_types.h"
...
#define PIDbrzina_rtModel              RT_MODEL_PIDbrzina_T
...
#define rtB                            PIDbrzina_B
#define BlockIO                        B_PIDbrzina_T
#define rtX                            PIDbrzina_X
#define ContinuousStates               X_PIDbrzina_T
#define rtXdot                         PIDbrzina_XDot
#define StateDerivatives               XDot_PIDbrzina_T
#define tXdis                          PIDbrzina_XDis
#define StateDisabled                  XDis_PIDbrzina_T
#define rtP                            PIDbrzina_P
#define Parameters                     P_PIDbrzina_T
#define rtDWork                        PIDbrzina_DW
#define D_Work                         DW_PIDbrzina_T

/* Parameters (auto storage) */
struct P_PIDbrzina_T_ {
  ...
  real_T TransferFcn_C;                /* Computed Parameter: TransferFcn_C
                                        * Referenced by: '<S2>/Transfer Fcn'
                                        */
  real_T Gain_Gain;                    /* Expression: -0.06
                                        * Referenced by: '<S2>/Gain'
                                        */
  real_T Gain1_Gain;                   /* Expression: (1000/1.5)
                                        * Referenced by: '<S3>/Gain1'
                                        */
  real_T Gain3_Gain;                   /* Expression: 1/70
                                        * Referenced by: '<S3>/Gain3'
                                        */
  real_T Gain4_Gain;                   /* Expression: pi/30
                                        * Referenced by: '<S3>/Gain4'
                                        */
  real_T Gain2_Gain;                   /* Expression: -2*pi/4096
  ...
  real_T Constant_Value;               /* Expression: 25
                                        ...
                                        */
  real_T SignalGenerator_Amplitude;    /* Expression: 12.5
...
extern P_PIDbrzina_T PIDbrzina_P;

/* Block signals (auto storage) */
extern B_PIDbrzina_T PIDbrzina_B;

/* Continuous states (auto storage) */
extern X_PIDbrzina_T PIDbrzina_X;

/* Block states (auto storage) */
extern DW_PIDbrzina_T PIDbrzina_DW;

/* Model entry point functions */
extern void PIDbrzina_initialize(void);
extern void PIDbrzina_output(void);
extern void PIDbrzina_update(void);
extern void PIDbrzina_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern PIDbrzina_rtModel *PIDbrzina(void);
...
extern RT_MODEL_PIDbrzina_T *const PIDbrzina_M;
 ...
 *
 * '<Root>' : 'PIDbrzina'
 * '<S1>'   : 'PIDbrzina/PID Controller'
 * '<S2>'   : 'PIDbrzina/Subsystem1'
 * '<S3>'   : 'PIDbrzina/Subsystem2'
 */
#endif                                 /* RTW_HEADER_PIDbrzina_h_ */
