...
MODEL                := PIDbrzina
MODULES              := PIDbrzina_data.c PIDbrzina_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             := PIDbrzina.mk
...
#
MODELLIB                  := PIDbrzinalib_sldrt.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := PIDbrzina_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;D:/Studentski_radovi/Helikopter/HELI2/PIDbrzina_sldrt_win64;D:/Studentski_radovi/Helikopter/HELI2;D:/Quanser/PI_demonstracija;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
