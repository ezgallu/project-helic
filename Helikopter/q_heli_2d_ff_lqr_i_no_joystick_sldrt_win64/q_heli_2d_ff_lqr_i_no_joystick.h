/*
 * q_heli_2d_ff_lqr_i_no_joystick.h
 *
...
#ifndef RTW_HEADER_q_heli_2d_ff_lqr_i_no_joystick_h_
#define RTW_HEADER_q_heli_2d_ff_lqr_i_no_joystick_h_
#include <math.h>
#include <string.h>
#ifndef q_heli_2d_ff_lqr_i_no_joystick_COMMON_INCLUDES_
# define q_heli_2d_ff_lqr_i_no_joystick_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#include "ext_work.h"
#include "sldrtdef.h"
#endif                                 /* q_heli_2d_ff_lqr_i_no_joystick_COMMON_INCLUDES_ */

#include "q_heli_2d_ff_lqr_i_no_joystick_types.h"
...
#define q_heli_2d_ff_lqr_i_no_joystick_rtModel RT_MODEL_q_heli_2d_ff_lqr_i_no_joystick_T
...
} B_q_heli_2d_ff_lqr_i_no_joystick_T;
...
} DW_q_heli_2d_ff_lqr_i_no_joystick_T;
...
} X_q_heli_2d_ff_lqr_i_no_joystick_T;
...
typedef struct {
  ...
  real_T Integrator_CSTATE_m;          /* '<S26>/Integrator' */
  real_T Integrator_CSTATE_e;          /* '<S28>/Integrator' */
} XDot_q_heli_2d_ff_lqr_i_no_joystick_T;
...
} XDis_q_heli_2d_ff_lqr_i_no_joystick_T;
...
} PrevZCX_q_heli_2d_ff_lqr_i_no_joystick_T;
...
#define rtB                            q_heli_2d_ff_lqr_i_no_joystick_B
#define BlockIO                        B_q_heli_2d_ff_lqr_i_no_joystick_T
#define rtX                            q_heli_2d_ff_lqr_i_no_joystick_X
#define ContinuousStates               X_q_heli_2d_ff_lqr_i_no_joystick_T
#define rtXdot                         q_heli_2d_ff_lqr_i_no_joystick_XDot
#define StateDerivatives               XDot_q_heli_2d_ff_lqr_i_no_joystick_T
#define tXdis                          q_heli_2d_ff_lqr_i_no_joystick_XDis
#define StateDisabled                  XDis_q_heli_2d_ff_lqr_i_no_joystick_T
#define rtP                            q_heli_2d_ff_lqr_i_no_joystick_P
#define Parameters                     P_q_heli_2d_ff_lqr_i_no_joystick_T
#define rtDWork                        q_heli_2d_ff_lqr_i_no_joystick_DW
#define D_Work                         DW_q_heli_2d_ff_lqr_i_no_joystick_T
#define rtPrevZCSigState               q_heli_2d_ff_lqr_i_no_joystick_PrevZCX
#define PrevZCSigStates                PrevZCX_q_heli_2d_ff_lqr_i_no_joystick_T

/* Parameters (auto storage) */
struct P_q_heli_2d_ff_lqr_i_no_joystick_T_ {
  ...
  real_T AmplitudePitchV_Gain;         /* Expression: 0
                                        ...
                                        */
  real_T ConstantPitchV_Value;         /* Expression: 0
                                        * Referenced by: '<S4>/Constant: Pitch (V)'
                                        */
  real_T Constant_Value_i;             /* Expression: 1
                                        * Referenced by: '<S15>/Constant'
                                        */
  real_T SignalGeneratorPitch_Amplitude;/* Expression: 20
  ...
  real_T X_Gain[16];                   /* Expression: -eye(4,4)
                                        * Referenced by: '<S7>/-X'
                                        */
  real_T SignalGeneratorYaw_Amplitude; /* Expression: 45
...
struct tag_RTM_q_heli_2d_ff_lqr_i_no_joystick_T {
  const char_T *path;
...
extern P_q_heli_2d_ff_lqr_i_no_joystick_T q_heli_2d_ff_lqr_i_no_joystick_P;

/* Block signals (auto storage) */
extern B_q_heli_2d_ff_lqr_i_no_joystick_T q_heli_2d_ff_lqr_i_no_joystick_B;

/* Continuous states (auto storage) */
extern X_q_heli_2d_ff_lqr_i_no_joystick_T q_heli_2d_ff_lqr_i_no_joystick_X;

/* Block states (auto storage) */
extern DW_q_heli_2d_ff_lqr_i_no_joystick_T q_heli_2d_ff_lqr_i_no_joystick_DW;

/* External data declarations for dependent source files */

/* Zero-crossing (trigger) state */
extern PrevZCX_q_heli_2d_ff_lqr_i_no_joystick_T
  q_heli_2d_ff_lqr_i_no_joystick_PrevZCX;

/* Model entry point functions */
extern void q_heli_2d_ff_lqr_i_no_joystick_initialize(void);
extern void q_heli_2d_ff_lqr_i_no_joystick_output(void);
extern void q_heli_2d_ff_lqr_i_no_joystick_update(void);
extern void q_heli_2d_ff_lqr_i_no_joystick_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern q_heli_2d_ff_lqr_i_no_joystick_rtModel *q_heli_2d_ff_lqr_i_no_joystick
  (void);
...
extern RT_MODEL_q_heli_2d_ff_lqr_i_no_joystick_T *const
 ...
 *
 * '<Root>' : 'q_heli_2d_ff_lqr_i_no_joystick'
 * '<S1>'   : 'q_heli_2d_ff_lqr_i_no_joystick/2 DOF Helicopter - Closed-loop Actual System'
 * '<S2>'   : 'q_heli_2d_ff_lqr_i_no_joystick/2 DOF Helicopter - Closed-loop System Simulation'
 * '<S3>'   : 'q_heli_2d_ff_lqr_i_no_joystick/Desired Angle from Program'
 * '<S4>'   : 'q_heli_2d_ff_lqr_i_no_joystick/Desired Voltage'
 * '<S5>'   : 'q_heli_2d_ff_lqr_i_no_joystick/Scopes'
 * '<S6>'   : 'q_heli_2d_ff_lqr_i_no_joystick/2 DOF Helicopter - Closed-loop Actual System/2DOF HELI'
 * '<S7>'   : 'q_heli_2d_ff_lqr_i_no_joystick/2 DOF Helicopter - Closed-loop Actual System/2DOF HELI: FF+LQR Controller'
 * '<S8>'   : 'q_heli_2d_ff_lqr_i_no_joystick/2 DOF Helicopter - Closed-loop Actual System/2DOF HELI: FF+LQR+I Controller'
 * '<S9>'   : 'q_heli_2d_ff_lqr_i_no_joystick/2 DOF Helicopter - Closed-loop Actual System/Controller Switch'
 * '<S10>'  : 'q_heli_2d_ff_lqr_i_no_joystick/2 DOF Helicopter - Closed-loop Actual System/2DOF HELI: FF+LQR Controller/Pitch feed-forward controller'
 * '<S11>'  : 'q_heli_2d_ff_lqr_i_no_joystick/2 DOF Helicopter - Closed-loop Actual System/2DOF HELI: FF+LQR+I Controller/Pitch Integral Antiwidup'
 * '<S12>'  : 'q_heli_2d_ff_lqr_i_no_joystick/2 DOF Helicopter - Closed-loop Actual System/2DOF HELI: FF+LQR+I Controller/Pitch feed-forward controller'
 * '<S13>'  : 'q_heli_2d_ff_lqr_i_no_joystick/2 DOF Helicopter - Closed-loop Actual System/2DOF HELI: FF+LQR+I Controller/Yaw Integral Antiwidup'
 * '<S14>'  : 'q_heli_2d_ff_lqr_i_no_joystick/2 DOF Helicopter - Closed-loop Actual System/Controller Switch/FF+LQR//FF+LQR+I Switch'
 * '<S15>'  : 'q_heli_2d_ff_lqr_i_no_joystick/2 DOF Helicopter - Closed-loop Actual System/Controller Switch/Latch: Pitch Voltage'
 * '<S16>'  : 'q_heli_2d_ff_lqr_i_no_joystick/2 DOF Helicopter - Closed-loop Actual System/Controller Switch/Latch: Yaw Voltage'
 * '<S17>'  : 'q_heli_2d_ff_lqr_i_no_joystick/2 DOF Helicopter - Closed-loop Actual System/Controller Switch/Pitch Relay'
 * '<S18>'  : 'q_heli_2d_ff_lqr_i_no_joystick/2 DOF Helicopter - Closed-loop Actual System/Controller Switch/Yaw Relay'
 * '<S19>'  : 'q_heli_2d_ff_lqr_i_no_joystick/2 DOF Helicopter - Closed-loop Actual System/Controller Switch/Latch: Pitch Voltage/Compare To Constant'
 * '<S20>'  : 'q_heli_2d_ff_lqr_i_no_joystick/2 DOF Helicopter - Closed-loop Actual System/Controller Switch/Latch: Yaw Voltage/Compare To Constant'
 * '<S21>'  : 'q_heli_2d_ff_lqr_i_no_joystick/2 DOF Helicopter - Closed-loop System Simulation/2DOF HELI: FF+LQR Controller'
 * '<S22>'  : 'q_heli_2d_ff_lqr_i_no_joystick/2 DOF Helicopter - Closed-loop System Simulation/2DOF HELI: FF+LQR+I Controller'
 * '<S23>'  : 'q_heli_2d_ff_lqr_i_no_joystick/2 DOF Helicopter - Closed-loop System Simulation/2DOF HELI: Nonlinear Model'
 * '<S24>'  : 'q_heli_2d_ff_lqr_i_no_joystick/2 DOF Helicopter - Closed-loop System Simulation/Controller Switch'
 * '<S25>'  : 'q_heli_2d_ff_lqr_i_no_joystick/2 DOF Helicopter - Closed-loop System Simulation/2DOF HELI: FF+LQR Controller/Pitch feed-forward controller'
 * '<S26>'  : 'q_heli_2d_ff_lqr_i_no_joystick/2 DOF Helicopter - Closed-loop System Simulation/2DOF HELI: FF+LQR+I Controller/Pitch Integral Antiwidup'
 * '<S27>'  : 'q_heli_2d_ff_lqr_i_no_joystick/2 DOF Helicopter - Closed-loop System Simulation/2DOF HELI: FF+LQR+I Controller/Pitch feed-forward controller'
 * '<S28>'  : 'q_heli_2d_ff_lqr_i_no_joystick/2 DOF Helicopter - Closed-loop System Simulation/2DOF HELI: FF+LQR+I Controller/Yaw Integral Antiwidup'
 * '<S29>'  : 'q_heli_2d_ff_lqr_i_no_joystick/2 DOF Helicopter - Closed-loop System Simulation/2DOF HELI: Nonlinear Model/Gravitational Torque'
 * '<S30>'  : 'q_heli_2d_ff_lqr_i_no_joystick/2 DOF Helicopter - Closed-loop System Simulation/2DOF HELI: Nonlinear Model/Pitch Position Dependent Torque'
 * '<S31>'  : 'q_heli_2d_ff_lqr_i_no_joystick/2 DOF Helicopter - Closed-loop System Simulation/2DOF HELI: Nonlinear Model/Yaw Inertia'
 * '<S32>'  : 'q_heli_2d_ff_lqr_i_no_joystick/2 DOF Helicopter - Closed-loop System Simulation/2DOF HELI: Nonlinear Model/Yaw Position Dependent Torque'
 * '<S33>'  : 'q_heli_2d_ff_lqr_i_no_joystick/2 DOF Helicopter - Closed-loop System Simulation/Controller Switch/FF+LQR//FF+LQR+I Switch'
 * '<S34>'  : 'q_heli_2d_ff_lqr_i_no_joystick/2 DOF Helicopter - Closed-loop System Simulation/Controller Switch/Latch: Pitch Voltage'
 * '<S35>'  : 'q_heli_2d_ff_lqr_i_no_joystick/2 DOF Helicopter - Closed-loop System Simulation/Controller Switch/Latch: Yaw Voltage'
 * '<S36>'  : 'q_heli_2d_ff_lqr_i_no_joystick/2 DOF Helicopter - Closed-loop System Simulation/Controller Switch/Pitch Relay'
 * '<S37>'  : 'q_heli_2d_ff_lqr_i_no_joystick/2 DOF Helicopter - Closed-loop System Simulation/Controller Switch/Yaw Relay'
 * '<S38>'  : 'q_heli_2d_ff_lqr_i_no_joystick/2 DOF Helicopter - Closed-loop System Simulation/Controller Switch/Latch: Pitch Voltage/Compare To Constant'
 * '<S39>'  : 'q_heli_2d_ff_lqr_i_no_joystick/2 DOF Helicopter - Closed-loop System Simulation/Controller Switch/Latch: Yaw Voltage/Compare To Constant'
 * '<S40>'  : 'q_heli_2d_ff_lqr_i_no_joystick/Desired Angle from Program/Constant: Pitch (deg)'
 * '<S41>'  : 'q_heli_2d_ff_lqr_i_no_joystick/Desired Angle from Program/Pitch: deg to rad'
 * '<S42>'  : 'q_heli_2d_ff_lqr_i_no_joystick/Desired Angle from Program/Yaw: deg to rad'
 * '<S43>'  : 'q_heli_2d_ff_lqr_i_no_joystick/Scopes/Radians to Degree - Sim States'
 * '<S44>'  : 'q_heli_2d_ff_lqr_i_no_joystick/Scopes/Radians to Degrees - Des. States'
 * '<S45>'  : 'q_heli_2d_ff_lqr_i_no_joystick/Scopes/Radians to Degrees - Meas. States'
 */
#endif                                 /* RTW_HEADER_q_heli_2d_ff_lqr_i_no_joystick_h_ */
