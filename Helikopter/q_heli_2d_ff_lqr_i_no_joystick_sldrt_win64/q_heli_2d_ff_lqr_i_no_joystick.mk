...
MODEL                := q_heli_2d_ff_lqr_i_no_joystick
MODULES              := q_heli_2d_ff_lqr_i_no_joystick_data.c q_heli_2d_ff_lqr_i_no_joystick_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_zcfcn.c 
MAKEFILE             := q_heli_2d_ff_lqr_i_no_joystick.mk
...
#
MODELLIB                  := q_heli_2d_ff_lqr_i_no_joysticklib_sldrt.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := q_heli_2d_ff_lqr_i_no_joystick_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;D:/Studentski_radovi/Helikopter/q_heli_2d_ff_lqr_i_no_joystick_sldrt_win64;D:/Studentski_radovi/Helikopter;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
