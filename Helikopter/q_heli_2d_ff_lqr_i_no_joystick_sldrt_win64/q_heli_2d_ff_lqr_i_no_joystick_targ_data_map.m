  ...
  ;%***********************
    ...
    ;%
    ;% Auto data (q_heli_2d_ff_lqr_i_no_joystick_P)
    ;%
      section.nData     = 46;
	  ...
	  ;% q_heli_2d_ff_lqr_i_no_joystick_P.K
	  section.data(5).logicalSrcIdx = 4;
	  section.data(5).dtTransOffset = 4;
	
	  ;% q_heli_2d_ff_lqr_i_no_joystick_P.K_AMP
	  ...
	  ;% q_heli_2d_ff_lqr_i_no_joystick_P.SAT_INT_ERR_PITCH
	  section.data(14).logicalSrcIdx = 13;
	  section.data(14).dtTransOffset = 20;
	
	  ;% q_heli_2d_ff_lqr_i_no_joystick_P.SAT_INT_ERR_YAW
	  section.data(15).logicalSrcIdx = 14;
	  section.data(15).dtTransOffset = 21;
	
	  ;% q_heli_2d_ff_lqr_i_no_joystick_P.Tr_p
	  section.data(16).logicalSrcIdx = 15;
	  section.data(16).dtTransOffset = 22;
	
	  ;% q_heli_2d_ff_lqr_i_no_joystick_P.Tr_y
	  section.data(17).logicalSrcIdx = 16;
	  section.data(17).dtTransOffset = 23;
	
	  ;% q_heli_2d_ff_lqr_i_no_joystick_P.VMAX_AMP_P
	  section.data(18).logicalSrcIdx = 17;
	  section.data(18).dtTransOffset = 24;
	
	  ;% q_heli_2d_ff_lqr_i_no_joystick_P.VMAX_AMP_Y
	  ...
	  ;% q_heli_2d_ff_lqr_i_no_joystick_P.l_cm
	  ...
	  ;% q_heli_2d_ff_lqr_i_no_joystick_P.EncoderInput_InputFilter
	  section.data(28).logicalSrcIdx = 27;
	  section.data(28).dtTransOffset = 34;
	
	  ;% q_heli_2d_ff_lqr_i_no_joystick_P.EncoderInput1_InputFilter
	  section.data(29).logicalSrcIdx = 28;
	  section.data(29).dtTransOffset = 35;
	
	  ;% q_heli_2d_ff_lqr_i_no_joystick_P.EncoderInput_MaxMissedTicks
	  section.data(30).logicalSrcIdx = 29;
	  section.data(30).dtTransOffset = 36;
	
	  ;% q_heli_2d_ff_lqr_i_no_joystick_P.EncoderInput1_MaxMissedTicks
	  section.data(31).logicalSrcIdx = 30;
	  section.data(31).dtTransOffset = 37;
	
	  ;% q_heli_2d_ff_lqr_i_no_joystick_P.AnalogOutput_MaxMissedTicks
	  section.data(32).logicalSrcIdx = 31;
	  section.data(32).dtTransOffset = 38;
	
	  ;% q_heli_2d_ff_lqr_i_no_joystick_P.AnalogOutput1_MaxMissedTicks
	  section.data(33).logicalSrcIdx = 32;
	  section.data(33).dtTransOffset = 39;
	
	  ;% q_heli_2d_ff_lqr_i_no_joystick_P.EncoderInput_YieldWhenWaiting
	  section.data(34).logicalSrcIdx = 33;
	  section.data(34).dtTransOffset = 40;
	
	  ;% q_heli_2d_ff_lqr_i_no_joystick_P.EncoderInput1_YieldWhenWaiting
	  section.data(35).logicalSrcIdx = 34;
	  section.data(35).dtTransOffset = 41;
	
	  ;% q_heli_2d_ff_lqr_i_no_joystick_P.AnalogOutput_YieldWhenWaiting
	  section.data(36).logicalSrcIdx = 35;
	  section.data(36).dtTransOffset = 42;
	
	  ;% q_heli_2d_ff_lqr_i_no_joystick_P.AnalogOutput1_YieldWhenWaiting
	  ...
	  ;% q_heli_2d_ff_lqr_i_no_joystick_P.AnalogOutput_VoltRange
	  section.data(7).logicalSrcIdx = 52;
	  section.data(7).dtTransOffset = 6;
	
	  ;% q_heli_2d_ff_lqr_i_no_joystick_P.AnalogOutput1_VoltRange
	  ...
	  ;% q_heli_2d_ff_lqr_i_no_joystick_P.SignalGeneratorPitchV_Frequency
	  ...
	  ;% q_heli_2d_ff_lqr_i_no_joystick_P.SignalGeneratorPitch_Frequency
	  ...
	  ;% q_heli_2d_ff_lqr_i_no_joystick_P.DerivativeFilterPitch_A
	  section.data(13).logicalSrcIdx = 66;
	  section.data(13).dtTransOffset = 12;
	
	  ;% q_heli_2d_ff_lqr_i_no_joystick_P.DerivativeFilterPitch_C
	  section.data(14).logicalSrcIdx = 67;
	  section.data(14).dtTransOffset = 14;
	
	  ;% q_heli_2d_ff_lqr_i_no_joystick_P.DerivativeFilterYaw_A
	  section.data(15).logicalSrcIdx = 68;
	  section.data(15).dtTransOffset = 16;
	
	  ;% q_heli_2d_ff_lqr_i_no_joystick_P.DerivativeFilterYaw_C
	  section.data(16).logicalSrcIdx = 69;
	  section.data(16).dtTransOffset = 18;
	
	  ;% q_heli_2d_ff_lqr_i_no_joystick_P.X_Gain
	  ...
	  ;% q_heli_2d_ff_lqr_i_no_joystick_P.SignalGeneratorYaw_Frequency
	  ...
	  ;% q_heli_2d_ff_lqr_i_no_joystick_P.X_Gain_k
	  section.data(23).logicalSrcIdx = 76;
	  section.data(23).dtTransOffset = 41;
	
	  ;% q_heli_2d_ff_lqr_i_no_joystick_P.ControlGainK_Gain
	  ...
	  ;% q_heli_2d_ff_lqr_i_no_joystick_P.SignalGeneratorYawV_Frequency
	  ...
	  ;% q_heli_2d_ff_lqr_i_no_joystick_P.X_Gain_j
	  section.data(47).logicalSrcIdx = 100;
	  section.data(47).dtTransOffset = 87;
	
	  ;% q_heli_2d_ff_lqr_i_no_joystick_P.X_Gain_d
	  section.data(48).logicalSrcIdx = 101;
	  section.data(48).dtTransOffset = 103;
	
	  ;% q_heli_2d_ff_lqr_i_no_joystick_P.ControlGainK_Gain_h
  ...
  ;%**************************
    ...
    ;%
    ;% Auto data (q_heli_2d_ff_lqr_i_no_joystick_B)
    ;%
      section.nData     = 153;
	  ...
	  ;% q_heli_2d_ff_lqr_i_no_joystick_B.Add
	  section.data(5).logicalSrcIdx = 4;
	  section.data(5).dtTransOffset = 4;
	  ...
	  ;% q_heli_2d_ff_lqr_i_no_joystick_B.TmpSignalConversionAtXInport1
	  section.data(18).logicalSrcIdx = 17;
	  section.data(18).dtTransOffset = 17;
	
	  ;% q_heli_2d_ff_lqr_i_no_joystick_B.X
	  section.data(19).logicalSrcIdx = 18;
	  ...
	  ;% q_heli_2d_ff_lqr_i_no_joystick_B.ControlGainK
	  section.data(27).logicalSrcIdx = 26;
	  section.data(27).dtTransOffset = 35;
	
	  ;% q_heli_2d_ff_lqr_i_no_joystick_B.X_l
	  section.data(28).logicalSrcIdx = 27;
	  ...
	  ;% q_heli_2d_ff_lqr_i_no_joystick_B.ControlGainK_l
	  section.data(32).logicalSrcIdx = 31;
	  ...
	  ;% q_heli_2d_ff_lqr_i_no_joystick_B.Add_m
	  section.data(45).logicalSrcIdx = 44;
	  ...
	  ;% q_heli_2d_ff_lqr_i_no_joystick_B.FeedforwardPitchGain
	  ...
	  ;% q_heli_2d_ff_lqr_i_no_joystick_B.Gain_l
	  section.data(67).logicalSrcIdx = 66;
	  section.data(67).dtTransOffset = 83;
	
	  ;% q_heli_2d_ff_lqr_i_no_joystick_B.Gain_lx
	  ...
	  ;% q_heli_2d_ff_lqr_i_no_joystick_B.TmpSignalConversionAtXInport1_i
	  section.data(73).logicalSrcIdx = 72;
	  section.data(73).dtTransOffset = 93;
	
	  ;% q_heli_2d_ff_lqr_i_no_joystick_B.Gain_b
	  ...
	  ;% q_heli_2d_ff_lqr_i_no_joystick_B.Add_i
	  section.data(76).logicalSrcIdx = 75;
	  section.data(76).dtTransOffset = 102;
	
	  ;% q_heli_2d_ff_lqr_i_no_joystick_B.X_c
	  ...
	  ;% q_heli_2d_ff_lqr_i_no_joystick_B.ControlGainK_j
	  section.data(81).logicalSrcIdx = 80;
	  section.data(81).dtTransOffset = 113;
	
	  ;% q_heli_2d_ff_lqr_i_no_joystick_B.X_n
	  ...
	  ;% q_heli_2d_ff_lqr_i_no_joystick_B.ControlGainK_b
	  ...
	  ;% q_heli_2d_ff_lqr_i_no_joystick_B.Add_l
	  ...
	  ;% q_heli_2d_ff_lqr_i_no_joystick_B.FeedforwardPitchGain_f
	  ...
	  ;% q_heli_2d_ff_lqr_i_no_joystick_B.PitchInertia
	  ...
	  ;% q_heli_2d_ff_lqr_i_no_joystick_B.PitchAdd1
	  ...
	  ;% q_heli_2d_ff_lqr_i_no_joystick_B.YawAdd1
	  ...
	  ;% q_heli_2d_ff_lqr_i_no_joystick_B.PitchAdd1_c
	  ...
	  ;% q_heli_2d_ff_lqr_i_no_joystick_B.YawAdd1_b
  ...
  ;%*******************
    ...
    ;%
    ;% Auto data (q_heli_2d_ff_lqr_i_no_joystick_DW)
    ;%
      section.nData     = 5;
      section.data(5)  = dumData; %prealloc
      
	  ;% q_heli_2d_ff_lqr_i_no_joystick_DW.Add_DWORK1
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	  ...
	  ;% q_heli_2d_ff_lqr_i_no_joystick_DW.EncoderInput_PWORK
	  section.data(1).logicalSrcIdx = 5;
	  section.data(1).dtTransOffset = 0;
	
	  ;% q_heli_2d_ff_lqr_i_no_joystick_DW.EncoderInput1_PWORK
	  section.data(2).logicalSrcIdx = 6;
	  section.data(2).dtTransOffset = 1;
	
	  ;% q_heli_2d_ff_lqr_i_no_joystick_DW.AnalogOutput_PWORK
	  section.data(3).logicalSrcIdx = 7;
	  section.data(3).dtTransOffset = 2;
	
	  ;% q_heli_2d_ff_lqr_i_no_joystick_DW.AnalogOutput1_PWORK
	  section.data(4).logicalSrcIdx = 8;
	  section.data(4).dtTransOffset = 3;
	
	  ;% q_heli_2d_ff_lqr_i_no_joystick_DW.psideg_PWORK.LoggedData
	  section.data(5).logicalSrcIdx = 9;
	  section.data(5).dtTransOffset = 4;
	
	  ;% q_heli_2d_ff_lqr_i_no_joystick_DW.psi_dotdegs_PWORK.LoggedData
	  section.data(6).logicalSrcIdx = 10;
	  section.data(6).dtTransOffset = 5;
	
	  ;% q_heli_2d_ff_lqr_i_no_joystick_DW.thetadeg_PWORK.LoggedData
	  section.data(7).logicalSrcIdx = 11;
	  section.data(7).dtTransOffset = 6;
	
	  ;% q_heli_2d_ff_lqr_i_no_joystick_DW.theta_dotdegs_PWORK.LoggedData
	  section.data(8).logicalSrcIdx = 12;
	  section.data(8).dtTransOffset = 7;
	
	  ;% q_heli_2d_ff_lqr_i_no_joystick_DW.Vm_actualV_PWORK.LoggedData
	  section.data(9).logicalSrcIdx = 13;
	  section.data(9).dtTransOffset = 8;
	
	  ;% q_heli_2d_ff_lqr_i_no_joystick_DW.Vm_simV_PWORK.LoggedData
  ...
  targMap.checksum0 = 4277653875;
  targMap.checksum1 = 3038224113;
  targMap.checksum2 = 3017464481;
  targMap.checksum3 = 1404449647;
