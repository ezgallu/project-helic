...
MODEL                := q_heli_2d_open_loop
MODULES              := q_heli_2d_open_loop_data.c q_heli_2d_open_loop_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             := q_heli_2d_open_loop.mk
...
#
MODELLIB                  := q_heli_2d_open_looplib_sldrt.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := q_heli_2d_open_loop_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;D:/Studentski_radovi/Helikopter/q_heli_2d_open_loop_sldrt_win64;D:/Studentski_radovi/Helikopter;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
