...
#ifndef RTW_HEADER_q_heli_2d_open_loop_h_
#define RTW_HEADER_q_heli_2d_open_loop_h_
#include <math.h>
#include <string.h>
#ifndef q_heli_2d_open_loop_COMMON_INCLUDES_
# define q_heli_2d_open_loop_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#include "ext_work.h"
#include "sldrtdef.h"
#endif                                 /* q_heli_2d_open_loop_COMMON_INCLUDES_ */

#include "q_heli_2d_open_loop_types.h"
...
#define q_heli_2d_open_loop_rtModel    RT_MODEL_q_heli_2d_open_loop_T

/* Block signals (auto storage) */
typedef struct {
  real_T SignalGeneratorPitchV;        /* '<S2>/Signal Generator: Pitch (V)' */
  real_T AmplitudePitchV;              /* '<S2>/Amplitude: Pitch (V)' */
  real_T Sum;                          /* '<S2>/Sum' */
  real_T PitchAMPVoltageLimit;         /* '<S1>/Pitch AMP Voltage Limit' */
  real_T PitchampGainPreCompensation;  /* '<S1>/Pitch amp Gain Pre-Compensation' */
  real_T SignalGeneratorYawV;          /* '<S2>/Signal Generator: Yaw (V)' */
  real_T AmplitudeYawV;                /* '<S2>/Amplitude: Yaw (V)' */
  real_T Sum1;                         /* '<S2>/Sum1' */
  real_T YawAMPVoltageLimit;           /* '<S1>/Yaw AMP Voltage Limit' */
  real_T YawampGainPreCompensation;    /* '<S1>/Yaw amp Gain Pre-Compensation' */
  real_T EncoderInput;                 /* '<S1>/Encoder Input' */
  real_T EncoderInput1;                /* '<S1>/Encoder Input1' */
  real_T EncoderResolutionPitch;       /* '<S1>/Encoder Resolution: Pitch ' */
  real_T Bias;                         /* '<S1>/Bias' */
  real_T DerivativeFilterPitch;        /* '<S1>/Derivative Filter: Pitch' */
  real_T DerivativeFilterYaw;          /* '<S1>/Derivative Filter: Yaw' */
  real_T EncoderResolutionYaw;         /* '<S1>/Encoder Resolution: Yaw' */
  real_T Gain[2];                      /* '<S5>/Gain' */
  real_T Gain_m[4];                    /* '<S6>/Gain' */
  real_T Gain_l[4];                    /* '<S4>/Gain' */
  real_T NoVm_sim;                     /* '<Root>/No Vm_sim' */
} B_q_heli_2d_open_loop_T;
...
typedef struct {
  ...
  void *EncoderInput1_PWORK;           /* '<S1>/Encoder Input1' */
  struct {
    void *LoggedData;
...
} DW_q_heli_2d_open_loop_T;

/* Continuous states (auto storage) */
typedef struct {
  real_T DerivativeFilterPitch_CSTATE[2];/* '<S1>/Derivative Filter: Pitch' */
  real_T DerivativeFilterYaw_CSTATE[2];/* '<S1>/Derivative Filter: Yaw' */
} X_q_heli_2d_open_loop_T;

/* State derivatives (auto storage) */
typedef struct {
  real_T DerivativeFilterPitch_CSTATE[2];/* '<S1>/Derivative Filter: Pitch' */
  real_T DerivativeFilterYaw_CSTATE[2];/* '<S1>/Derivative Filter: Yaw' */
} XDot_q_heli_2d_open_loop_T;

/* State disabled  */
typedef struct {
  boolean_T DerivativeFilterPitch_CSTATE[2];/* '<S1>/Derivative Filter: Pitch' */
  boolean_T DerivativeFilterYaw_CSTATE[2];/* '<S1>/Derivative Filter: Yaw' */
} XDis_q_heli_2d_open_loop_T;
...
#define rtB                            q_heli_2d_open_loop_B
#define BlockIO                        B_q_heli_2d_open_loop_T
#define rtX                            q_heli_2d_open_loop_X
#define ContinuousStates               X_q_heli_2d_open_loop_T
#define rtXdot                         q_heli_2d_open_loop_XDot
#define StateDerivatives               XDot_q_heli_2d_open_loop_T
#define tXdis                          q_heli_2d_open_loop_XDis
#define StateDisabled                  XDis_q_heli_2d_open_loop_T
#define rtP                            q_heli_2d_open_loop_P
#define Parameters                     P_q_heli_2d_open_loop_T
#define rtDWork                        q_heli_2d_open_loop_DW
#define D_Work                         DW_q_heli_2d_open_loop_T

/* Parameters (auto storage) */
struct P_q_heli_2d_open_loop_T_ {
  ...
  int32_T AnalogOutput1_VoltRange;     /* Mask Parameter: AnalogOutput1_VoltRange
                                        * Referenced by: '<S1>/Analog Output1'
                                        */
  real_T SignalGeneratorPitchV_Amplitude;/* Expression: 3
                                          * Referenced by: '<S2>/Signal Generator: Pitch (V)'
                                          */
  real_T SignalGeneratorPitchV_Frequency;/* Expression: 0.0001
                                          * Referenced by: '<S2>/Signal Generator: Pitch (V)'
                                          */
  real_T AmplitudePitchV_Gain;         /* Expression: 0.8
                                        * Referenced by: '<S2>/Amplitude: Pitch (V)'
                                        */
  real_T ConstantPitchV_Value;         /* Expression: 0
                                        * Referenced by: '<S2>/Constant: Pitch (V)'
                                        */
  real_T SignalGeneratorYawV_Amplitude;/* Expression: 3
                                        * Referenced by: '<S2>/Signal Generator: Yaw (V)'
                                        */
  real_T SignalGeneratorYawV_Frequency;/* Expression: 0.4
                                        * Referenced by: '<S2>/Signal Generator: Yaw (V)'
                                        */
  real_T AmplitudeYawV_Gain;           /* Expression: 0.7
  ...
  real_T DerivativeFilterYaw_C[2];     /* Computed Parameter: DerivativeFilterYaw_C
                                        * Referenced by: '<S1>/Derivative Filter: Yaw'
                                        */
  real_T NoDesired_Value[2];           /* Expression: [0 0]
  ...
  real_T Gain_Gain_h;                  /* Expression: 180/pi
                                        ...
                                        */
  real_T NoSimulation_Value[4];        /* Expression: [0 0 0 0]
                                        * Referenced by: '<Root>/No Simulation'
                                        */
  real_T Gain_Gain_k;                  /* Expression: 180/pi
                                        * Referenced by: '<S4>/Gain'
                                        */
  real_T NoVm_sim_Value;               /* Expression: 0
                                        * Referenced by: '<Root>/No Vm_sim'
                                        */
};

/* Real-time Model Data Structure */
struct tag_RTM_q_heli_2d_open_loop_T {
  const char_T *path;
...
extern P_q_heli_2d_open_loop_T q_heli_2d_open_loop_P;

/* Block signals (auto storage) */
extern B_q_heli_2d_open_loop_T q_heli_2d_open_loop_B;

/* Continuous states (auto storage) */
extern X_q_heli_2d_open_loop_T q_heli_2d_open_loop_X;

/* Block states (auto storage) */
extern DW_q_heli_2d_open_loop_T q_heli_2d_open_loop_DW;

/* Model entry point functions */
extern void q_heli_2d_open_loop_initialize(void);
extern void q_heli_2d_open_loop_output(void);
extern void q_heli_2d_open_loop_update(void);
extern void q_heli_2d_open_loop_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern q_heli_2d_open_loop_rtModel *q_heli_2d_open_loop(void);
...
extern RT_MODEL_q_heli_2d_open_loop_T *const q_heli_2d_open_loop_M;
 ...
 *
 * '<Root>' : 'q_heli_2d_open_loop'
 * '<S1>'   : 'q_heli_2d_open_loop/2DOF HELI'
 * '<S2>'   : 'q_heli_2d_open_loop/Open-loop Voltage from Program'
 * '<S3>'   : 'q_heli_2d_open_loop/Scopes'
 * '<S4>'   : 'q_heli_2d_open_loop/Scopes/Radians to Degree - Sim States'
 * '<S5>'   : 'q_heli_2d_open_loop/Scopes/Radians to Degrees - Des. States'
 * '<S6>'   : 'q_heli_2d_open_loop/Scopes/Radians to Degrees - Meas. States'
 */
#endif                                 /* RTW_HEADER_q_heli_2d_open_loop_h_ */
