...
MODEL                := q_heli_2d_ff_lqr_i_nas
MODULES              := q_heli_2d_ff_lqr_i_nas_data.c q_heli_2d_ff_lqr_i_nas_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_zcfcn.c 
MAKEFILE             := q_heli_2d_ff_lqr_i_nas.mk
...
#
MODELLIB                  := q_heli_2d_ff_lqr_i_naslib_sldrt.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := q_heli_2d_ff_lqr_i_nas_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;D:/Studentski_radovi/Helikopter/q_heli_2d_ff_lqr_i_nas_sldrt_win64;D:/Studentski_radovi/Helikopter;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
